...
class SearchBarViewController: UIViewController {
    ...
    private let searchBar: UISearchBar = {
        ...
        searchBar.placeholder = "Search for creators"
        return searchBar
    }()
    ...
    private let tableView: UITableView = {
        ...
        table.isHidden = true
        table.register(SearchBarCell.self,
                       forCellReuseIdentifier: SearchBarCell.identifier)
...
extension SearchBarViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: SearchBarCell.identifier,
                                                 for: indexPath) as! SearchBarCell
